...
testdata = [
    Contact(firstname="firstname1", middlename="middlename1", lastname="lastname1", nickname="nickname1",
                      ...
                      fax="fax1", email="email1", email2="email2", email3="email3",
                      homepage="homepage1", bday="1", bmonth="June", byear="1990", aday="2", amonth="June",
                      ayear="", address2="", secondaryphone="1212", notes="notes1")]
